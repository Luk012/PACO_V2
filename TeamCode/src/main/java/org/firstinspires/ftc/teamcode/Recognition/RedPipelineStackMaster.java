...
public class RedPipelineStackMaster {
    private OpenCvWebcam webcam;

    private String itemStatus;
    public RedPipelineStack opencvred = null;
    private LinearOpMode op;
    public RedPipelineStackMaster(LinearOpMode p_op){
    ...
    public void observeStick(){
        //create the pipeline
        opencvred = new RedPipelineStack();
        ...
        webcam.openCameraDeviceAsync(new OpenCvCamera.AsyncCameraOpenListener()
        {
            ...
            public void onOpened()
            {
                 ...
                 * away from the user.
                 */
                webcam.setPipeline(opencvred);
                //start streaming the camera
                webcam.startStreaming(640, 360, OpenCvCameraRotation.UPRIGHT);

                while (!opencvred.hasProcessedFrame) op.sleep(50);

                itemStatus = opencvred.getWhichSide();
