...
public class BluePipelineStackMaster {
    private OpenCvWebcam webcam;

    private String itemStatus;
    public BluePipelineStack opencvstack = null;
    private LinearOpMode op;
    public BluePipelineStackMaster(LinearOpMode p_op){
    ...
    public void observeStick(){
        //create the pipeline
        opencvstack = new BluePipelineStack();
