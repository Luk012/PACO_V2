...
import org.firstinspires.ftc.teamcode.Recognition.BlueOpenCVMaster;
import org.firstinspires.ftc.teamcode.Recognition.BluePipelineStackMaster;
import org.firstinspires.ftc.teamcode.Recognition.CustomOpenCVPipeline;
import org.firstinspires.ftc.teamcode.Recognition.OpenCVMaster;
import org.firstinspires.ftc.teamcode.Recognition.RedPipelineStackMaster;
...
public class BlueLeftNearWall extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d stack = new Pose2d(x_stack+4, y_stack+0.5, Math.toRadians(angle_stack));
        Pose2d prepare_for_stack = new Pose2d(x_prepare_for_stack, y_prepare_for_stack-7.5, Math.toRadians(angle_prepare));
        Pose2d lung_de_linie = new Pose2d(x_lung_de_linie-11, y_lung_de_linie-7.5, Math.toRadians(angle_lung_de_linie));
        ...
        Pose2d prepare_for_stack_score = new Pose2d(x_prepare_for_stack, y_prepare_for_stack+6.5, Math.toRadians(angle_prepare));
        Pose2d lung_de_linie_score = new Pose2d(x_lung_de_linie-2, y_lung_de_linie+6.5, Math.toRadians(angle_lung_de_linie));
