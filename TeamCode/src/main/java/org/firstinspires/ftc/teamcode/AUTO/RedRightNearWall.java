...
public class RedRightNearWall extends LinearOpMode {
    ...
    public static double x_purple_left = 29.5, y_purple_left = -36, angle_purple_left = 90;
    ...
    public static double x_yellow_right = 50, y_yellow_right = -31.5, angle_yellow_right = 180;
