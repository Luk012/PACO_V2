...
public class RedLeftNearCenter extends LinearOpMode {
    ...
    public static double x_purple_center = -35.5, y_purple_center = -11, angle_purple_center = 90;
    public static double x_purple_right = -31.5, y_purple_right = -18, angle_purple_right = 90;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d yellow_center_2 = new Pose2d(x_yellow_center, y_yellow_center+3.5, Math.toRadians(angle_yellow_center));
        Pose2d stack_center_2 = new Pose2d(x_stack - 6, y_stack, Math.toRadians(angle_stack));
